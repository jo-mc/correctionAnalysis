...
### Reads that could <span style="color:red">not be corrected</span>: 8302 of 261177  ??????? a lot less than to Ash ref ?   (~3%)
<!-- chr6 figure:  https://ghr.nlm.nih.gov/chromosome/6#idiogram -->
![chr6](chr6.png)

#### Aligned with minimap to the <span style="color:red">GRCh38 Reference</span>.


```{r echo=FALSE}
passData <- read.table("C:/BIGDATA______TEMPORARY/HG002chr6Correction/pass5_noimp.txt")
```
