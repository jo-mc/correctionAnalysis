...
#### Corrected Reads: 252875 of 261177   (~97%)  [less than ash ref]
<!-- chr6 figure:  https://ghr.nlm.nih.gov/chromosome/6#idiogram -->
![chr6 ideogram](chr6.png)

#### Aligned with minimap to the <span style="color:red">GRCh38</span> Reference.

```{r echo=FALSE}
passData <- read.table("C:/BIGDATA______TEMPORARY/HG002chr6Correction/pass5_imp.txt", skip =3)
```
